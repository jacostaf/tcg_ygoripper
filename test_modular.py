...
def test_imports():
    ...
    try:
        # Test configuration
        from ygoapi.config import MEM_LIMIT_MB, get_port, validate_config
        ...
        # Test utilities
        from ygoapi.utils import extract_art_version, normalize_rarity
...
def test_basic_functionality():
    ...
    try:
        ...
        # Test configuration
        from ygoapi.config import MEM_LIMIT_MB, get_port
