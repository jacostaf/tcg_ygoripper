...
PRICE_SCRAPING_TIMEOUT_SECONDS = 3600  # Overall operation timeout (1 hour)
PRICE_SCRAPING_MAX_RETRIES = 3
PRICE_SCRAPING_RETRY_DELAY = 5

# Playwright-specific timeout configurations
PLAYWRIGHT_PAGE_TIMEOUT_MS = int(os.getenv("PLAYWRIGHT_PAGE_TIMEOUT_MS", "3600000"))  # 1 hour for page operations
PLAYWRIGHT_NAVIGATION_TIMEOUT_MS = int(os.getenv("PLAYWRIGHT_NAVIGATION_TIMEOUT_MS", "3600000"))  # 1 hour for navigation
PLAYWRIGHT_DEFAULT_TIMEOUT_MS = int(os.getenv("PLAYWRIGHT_DEFAULT_TIMEOUT_MS", "3600000"))  # 1 hour default timeout

# Price Cache CollectionYGO_CARD_VARIANT_PRICE_CACHE_V1"
PRICE_CACHE_COLLECTION = "YGO_CARD_VARIANT_PRICE_CACHE_V1"
# PRICE_CACHE_COLLECTION = "YGO_PRICE_CACHE_V1"
# PRICE_CACHE_COLLECTION = "YGOasdf_PRICE_CACHE_V1"
