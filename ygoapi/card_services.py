...
from .database import get_card_sets_collection, get_card_variants_collection, get_database_manager
from .memory_manager import get_memory_manager, monitor_memory
from .models import CardModel, CardVariantModel, ProcessingStats
from .utils import (
...
class CardSetService:
    ...
    def fetch_all_card_sets(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            response = requests.get(f"{YGO_API_BASE_URL}/cardsets.php", timeout=30)
