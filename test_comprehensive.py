...
def test_memory_management():
    ...
    from ygoapi.memory_manager import force_memory_cleanup, get_memory_manager, get_memory_stats
...
def test_models():
    ...
    from ygoapi.models import CardPriceModel, MemoryStats, ProcessingStats
    ...
    stats = ProcessingStats(
        total_sets=100, processed_sets=95, failed_sets=5, total_cards_processed=50000
    )
